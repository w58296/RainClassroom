...
public class Teacher_Collection extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            System.out.println("Teacher_Collection CoreJson:::::::::::::::::::::::");
        ...
        try {
            ...
            for(int i=0;i<dataJson.length();i++){
                ...
                LinearLayout layout = (LinearLayout) inflater.inflate(
                        R.layout.onecollection, null).findViewById(R.id.AddOneCollection);
                lin.addView(layout);
            }
...
//                                        if(temptype=="question"){
                                        ...
                                        intent = new Intent(Teacher_Collection.this, Teacher_ProblemCollectionInfo.class);
...
//                                            intent = new Intent(Teacher_Collection.this, Teacher_PPTCollection.class);
//                                            intent.putExtra("description",tempdescription);
//                                            intent.putExtra("type",temptype);
//                                        }
                                    }
