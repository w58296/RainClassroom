...
public class Student_TestQuestioinAnswering extends AppCompatActivity {
    ...
    public void getQuestion() {
        ...
        Request request = new Request.Builder()
                .url("http://172.20.10.8:8080/stu/getquestion")
                .build();
    ...
    public void sendQuestionAnswer(JSONObject CoreJson){
        ...
        String url = user.IP+"/stu/dis/sendAnswer";
        Request request = new Request.Builder()
                .url(url)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.student_activity_test_questioin_answering);
