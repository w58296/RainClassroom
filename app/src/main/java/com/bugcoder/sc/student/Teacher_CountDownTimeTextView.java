...
public class Teacher_CountDownTimeTextView extends AppCompatTextView {
    ...
    public Teacher_CountDownTimeTextView(Context context) {
        super(context);
        init(context, null);
    }

    public Teacher_CountDownTimeTextView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public Teacher_CountDownTimeTextView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
