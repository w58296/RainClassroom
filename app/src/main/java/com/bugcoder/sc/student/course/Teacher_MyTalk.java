...
public class Teacher_MyTalk extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Teacher_Talk talk = (Teacher_Talk) getIntent().getSerializableExtra("talk_data");
        stuId=talk.getStuId();
        date=talk.getDate();
...
//设置在listview上下拉刷新的监听
        mSwipeLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                load();
                Toast.makeText(Teacher_MyTalk.this,"刷新成功", Toast.LENGTH_SHORT).show();
...
//        scrollView.fullScroll(ScrollView.FOCUS_DOWN);
        talk_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Teacher_User user = new Teacher_User();
                String url = user.IP+"/stu/dis/sttdiscuss";
