...
public class Student_TalkMain extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.student_activity_talkmain);
...
//设置在listview上下拉刷新的监听
        mSwipeLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                load();
                Toast.makeText(Student_TalkMain.this,"刷新成功", Toast.LENGTH_SHORT).show();
...
//        android.support.v7.widget.CardView cardView = new android.support.v7.widget.CardView(this);
        ...
        cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Student_Talk talk=new Student_Talk(stuId,courseName,question,data,textView3.getText().toString(),name);
                Intent intent = new Intent(getApplicationContext(), Student_MyTalk.class);
    ...
    void load(){
        ...
        RequestBody requestBody = FormBody.create(MediaType.parse("application/json; charset=utf-8"), String.valueOf(jsonObject));
        Request request = new Request.Builder()
                .url("http://192.168.43.157:8080/stu/dis/enterQues")//请求的url
                .post(requestBody)
                .build();
