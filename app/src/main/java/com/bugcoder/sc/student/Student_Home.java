...
import com.bugcoder.sc.student.course.Student_CourseLiving;
import com.bugcoder.sc.student.course.Student_Courses;
import com.bugcoder.sc.student.favourite.Student_Collection;
import com.bugcoder.sc.student.schedule.Student_Schedule;
...
public class Student_Home extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initData();
        initUI();
        Student_Schedule s = new Student_Schedule("Android", "Zhang Di", "08:00 - 10:00", "YF205", "12 Jul 2019");
        addSchedule(s);
//        Student_Schedule s1 = new Student_Schedule("asdfghjkl","Zhang Di","08:00 - 10:00","YF205","12 Jul 2019");
//        addSchedule(s1);
                ...
                case 1:
                    try {
                        ...
                        for (int i = 0; i < v.size(); i++) {
                            ...
                            addSchedule((Student_Schedule) v.elementAt(i));
    ...
    private void parseJsonWithJsonObject(String responseData) throws IOException {
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                v.addElement(new Student_Schedule(courseName, teacherName, time, room,date));
    ...
    void addSchedule(final Student_Schedule schedule) {
        ...
        cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(getApplicationContext(), Student_CourseLiving.class);
        ...
        tv_time.setCompoundDrawablesWithIntrinsicBounds(getResources().getDrawable(R.drawable.student_ic_access_time_red_24dp), null, null, null);
        ...
        tv_date.setCompoundDrawablesWithIntrinsicBounds(getResources().getDrawable(R.drawable.student_ic_event_available_red_16dp), null, null, null);
        ...
        tv_room.setCompoundDrawablesWithIntrinsicBounds(getResources().getDrawable(R.drawable.student_ic_location_on_red_24dp), null, null, null);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.student_home_bar, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        // automatically handle clicks on the Student_Home/Up button, so long
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_courses) {
            ...
            Intent intent = new Intent(getApplicationContext(), Student_Announcements.class);
            intent.putExtra("stuId",stuId);
            startActivity(intent);
        } else if (id == R.id.nav_favourite) {
            Intent intent = new Intent(getApplicationContext(), Student_Collection.class);
            intent.putExtra("stuId",stuId);
            startActivity(intent);
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.profile) {
            Intent intent = new Intent(getApplicationContext(), Student_MyProfile.class);
            startActivity(intent);
        }
    }
}
