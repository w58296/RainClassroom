...
import example.rico.calendar.dialog.InputLocationDialog;
import example.rico.calendar.dialog.SelectDateDialog;
import example.rico.calendar.dialog.SelectEventSetDialog;
import example.rico.calendar.task.eventset.LoadEventSetMapTask;
import example.rico.calendar.task.schedule.UpdateScheduleTask;
import example.rico.calendar.utils.DateUtils;
...
public class ScheduleDetailActivity extends BaseActivity implements View.OnClickListener, OnTaskFinishedListener<Map<Integer, EventSet>>, SelectDateDialog.OnSelectDateListener, InputLocationDialog.OnLocationBackListener, SelectEventSetDialog.OnSelectEventSetListener {
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.tvCancel) {
            ...
            confirm();
        } else if (id == R.id.llScheduleEventSet) {
