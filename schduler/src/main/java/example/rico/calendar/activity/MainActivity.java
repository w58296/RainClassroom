...
import example.rico.calendar.adapter.EventSetAdapter;
import yang.rico.common.bean.EventSet;
import example.rico.calendar.fragment.EventSetFragment;
...
public class MainActivity extends BaseActivity implements View.OnClickListener, OnTaskFinishedListener<List<EventSet>> {
    ...
    public void onClick(View v) {
        ...
        } else if (id == R.id.llMenuSchedule) {
            gotoScheduleFragment();
        } else if (id == R.id.llMenuNoCategory) {
